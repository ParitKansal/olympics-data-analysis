...
def data_over_time(df, col):
    temp1 = df.drop_duplicates(['Year', col])['Year'].value_counts().reset_index().sort_values('Year')
    return temp1.rename(columns={'count': col + ' count'})
...
def most_successful(df, sport):
    ...
    x.rename(columns={'region': 'Region', 'count': 'Medals'}, inplace=True)
